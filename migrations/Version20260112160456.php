 ...
 */
final class Version20260112160456 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial setup: Checks if tables exist before creating them to safely handle pre-existing schemas.';
    }

    public function up(Schema $schema): void
    {
        // --- SAFETY CHECK ---
        // If 'custom_id_format' exists, we assume the database was already created 
        // via schema:update --force. We skip this migration to prevent errors.
        if ($this->connection->createSchemaManager()->tablesExist(['custom_id_format'])) {
            $this->write('Database tables already exist. Skipping migration.');
            return;
        }
        // --------------------
