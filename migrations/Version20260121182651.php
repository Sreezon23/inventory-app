...
final class Version20260121182651 extends AbstractMigration
{
    ...
    {
        // CREATE api_token table - only if it doesn't exist
        ...
        // CREATE unique index on api_token.token - only if it doesn't exist
        if ($schema->hasTable('api_token')) {
        ...
        // Drop inventory_api_token if it exists
        ...
        // Drop salesforce_integration if it exists
        ...
        // Drop support_ticket if it exists
        ...
        // Handle inventory_discussion_post modifications
        ...
        // Handle inventory_field modifications
        ...
        // Handle inventory_item modifications
        ...
        // Handle item_like modifications
    ...
    {
        // Reverse all operations with safety checks
        if (!$schema->hasTable('inventory_api_token')) {
